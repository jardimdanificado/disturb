...
SRC = src/vm.c src/bytecode.c src/syntax.c src/functions.c src/host_io.c src/papagaio_wasm.c src/papagaio.c src/cli.c src/ffi.c
OBJ = $(SRC:.c=.o)
...
wasm: $(WASM_TARGET)
	...
	cp -f papagaio.js papagaio.wasm examples/web/
...
$(OBSIDIAN_PLUGIN_DIR):
	...
	cp -r papagaio.js papagaio.wasm $@
